...
| Case | 文件 | 在线预览 | 覆盖能力 |
|------|------|---------|---------|
| 贝加尔湖自驾 | `examples/index.html` | [预览](https://513e84b52fcd4db29f414aa873cf3ef9.app.codebuddy.work) | 出境/多口岸/飞航段/双返程方案 |
| G331 东北边境环线 | `examples/G331/G331东北边境自驾环线.html` | [预览](https://bf8995ec1d4c49c199b65d964e842517.app.codebuddy.work) | 境内/口岸筛选/草原支线/路况三角 |
